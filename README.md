...
## Quick Start
### Para facilitar a vida, no diretório do projeto você pode rodar utilizando o docker-compose:
        docker-compose up -d
        docker-compose logs -t -f --tail=10
Depois é só abrir no navegador: http://127.0.0.1:1880/ , ou você pode me ignorar e seguir com o descrito a seguir.
